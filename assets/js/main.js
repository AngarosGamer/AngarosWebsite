...
function submitForm() {
  ...
  if(selectedValue == "ethash"){
    ...
    var urlParam = "hr=" + document.getElementById("hash").value + "&p=0&fee=0.0&cost=0&cost_currency=USD&hcost=0.0&span_br=&span_d=24&commit=Calculate";
    var URL = "https://www.whattomine.com/coins/162-etc-etchash";
    var encodedUrl = URL + "?" + encodeURI(urlParam);
    window.location.href = encodedUrl;
